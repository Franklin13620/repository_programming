...
<html lang="es">
  <head>
	...
	background-image: url(img/loginFont2.jpg);
    ...
    <!-- Fav and touch icons -->
 <!--<link rel="icon" type="image/ugb" sizes="32x32" href="ico/favicon.png"> -->

 <link rel="icon" type="image/png" href="img/icoLogin.ico" />
  </head>
  ...
  <body>
    ...
    <div class="container">
	  <form name="form1" method="post" action="" class="form-signin">
      	<center><img src="img/login.png" width="200" height="200"></center><br>
      	<?php 
